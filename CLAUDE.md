...
│   ├── iphone/               # current source: manual USB import (see section 5)
...
**Current state (as of 2026-07-12):** extraction matched **749 UK trip photos + 15 DC/Rania photos (764 total)**; of those, **734 UK trip photos** fall within the 9-day gallery window and are live on the site — all 9 days have real photo coverage (Cotswolds: 133, Cambridge: 86, Mon 6 Jul: 24). Photo gallery is live (thumbnail grid, lightbox, per-event and per-map-pin links). Still pending: the manual curation/review pass ([#9](https://github.com/harveystephenson/London-2026/issues/9), [#10](https://github.com/harveystephenson/London-2026/issues/10)) and the `pruned_review/` reconciliation ([#24](https://github.com/harveystephenson/London-2026/issues/24)).
