...
- Removed entirely (never happened): Pride Parade, the Chelsea breakfast, Churchill Arms, Harry Potter Studios, the Sketch dinner on 29 Jun (#41, removed 2026-07-13 — no flag or tagged photos ever existed for it)
- Added: The Notting Hill Bookshop (the film's bookstore), Cutie's trip to Liverpool Street Station, High Tea at Jacqueline (The Chancery Rosewood), a Burford stop in the Cotswolds, Battersea Power Station + Italian dinner on 6 Jul (#42, added 2026-07-13 — restaurant name is a placeholder, see section 6)
...
- **Two restaurant names unknown, placeholders in the schedule:** the Cotswolds lunch (Fri 3 Jul, "restaurant to confirm from photos") and the Italian dinner at Battersea Power Station (Mon 6 Jul, added in #42). Fill in once photos identify the venues.
